...
\title{The Annotated ML KEM Scheme\TwoPtSp {\large{Rejection Sampling in ML-KEM}}}
\AuthorDeviPrasad
\date{\today}
...
\newpage
\section{Compression and Decompression Algorithms.}
\begin{algorithm}[H]
...
\section{Algorithm 5. ByteEncode.}
...
\section{Algorithm 5. ByteDecode.}
...
\section{Algorithm 8: SamplePolyCBD.}
